...
namespace NationalInstruments.Veristand
{
    ...
    public class TimedStructuresTypeFactory : IPluginNodeFactory
    {
        public bool TryCreateBaseNodeFromSystemStorageNode(BaseNodeType storageNode, out BaseNode baseNode)
        {
            ...
            if (storageNode.TypeGUID == TimedStructuresType.TypeGuid)
            {
                baseNode = new TimedStructuresType(storageNode);
                return true;
            }
