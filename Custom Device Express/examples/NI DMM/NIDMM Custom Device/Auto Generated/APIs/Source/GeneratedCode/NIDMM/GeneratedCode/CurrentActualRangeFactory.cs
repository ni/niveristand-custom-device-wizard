...
namespace NationalInstruments.Veristand
{
    ...
    public class CurrentActualRangeFactory : IPluginNodeFactory
    {
        public bool TryCreateBaseNodeFromSystemStorageNode(BaseNodeType storageNode, out BaseNode baseNode)
        {
            ...
            if (storageNode.TypeGUID == CurrentActualRange.TypeGuid)
            {
                baseNode = new CurrentActualRange(storageNode);
                return true;
            }
