...
namespace NationalInstruments.Veristand
{
    ...
    public class VoltageActualRangeFactory : IPluginNodeFactory
    {
        public bool TryCreateBaseNodeFromSystemStorageNode(BaseNodeType storageNode, out BaseNode baseNode)
        {
            ...
            if (storageNode.TypeGUID == VoltageActualRange.TypeGuid)
            {
                baseNode = new VoltageActualRange(storageNode);
                return true;
            }
